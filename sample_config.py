...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "scarpbot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "scarpbot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/KenalSayaaa")
